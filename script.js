...
function generateObstacles() {
    const maxObstacles = 8; // Establecer el número máximo de obstáculos en pantalla
    const obstacleHeightRange = [80, 100, 110]; // Rango de alturas para las bombas
    ...
    function generateSingleObstacle() {
        ...
        // Definir el rango vertical para las bombas (entre 100px y 400px desde la parte superior de la pantalla)
        const minHeight = 400;
        const maxHeight = 250;
    
        // Generar una posición vertical aleatoria dentro del rango establecido
        const obstacleTop = Math.floor(Math.random() * (maxHeight - minHeight + 1)) + minHeight;
        ...
        function moveSingleObstacle() {
            ...
            if (obstaclePosition < -50) {
                ...
                // Mover el obstáculo hacia la izquierda
                obstaclePosition -= 17; // Reducir este valor para mover el obstáculo más lento
